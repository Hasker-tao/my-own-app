...
![学习模块课程总览](docs/images/learning-course-overview.png)

学习模块集中展示本学期课程，并按已确认学过的课件估算进度。每门课程还会单独记录考试前复习进度、重要 Part 和 Moodle 同步状态。

### Coursework 状态

![Coursework 状态示例，私人信息已遮挡](docs/images/coursework-status-redacted.png)

Coursework 待办汇总截止时间、学校提交状态、上传文件、评分状态和反馈。示例图中的学号、文件名和成绩数值已经遮挡。

### 健身循环计划

![健身循环计划与记录](docs/images/fitness-recurring-plan.png)

健身模块将按星期和周期间隔设置的循环计划显示在日历中，并在同一页面记录每日完成情况和体重变化。
